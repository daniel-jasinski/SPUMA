...
// Complex transcendental functions: use host-only path on HIP.
// MSVC STL <complex> has host-only internal functions (_Exp, swap) that
// are incompatible with HIP device compilation. CUDA handles this via
// different __host__/__device__ inference rules.
#if defined(have_hip)
UNARY_FUNCTION_HOST(complex, complex, pow025)
UNARY_FUNCTION_HOST(complex, complex, sqrt)
UNARY_FUNCTION_HOST(complex, complex, exp)
UNARY_FUNCTION_HOST(complex, complex, log)
UNARY_FUNCTION_HOST(complex, complex, log10)
UNARY_FUNCTION_HOST(complex, complex, sin)
UNARY_FUNCTION_HOST(complex, complex, cos)
UNARY_FUNCTION_HOST(complex, complex, tan)
UNARY_FUNCTION_HOST(complex, complex, asin)
UNARY_FUNCTION_HOST(complex, complex, acos)
UNARY_FUNCTION_HOST(complex, complex, atan)
UNARY_FUNCTION_HOST(complex, complex, sinh)
UNARY_FUNCTION_HOST(complex, complex, cosh)
UNARY_FUNCTION_HOST(complex, complex, tanh)
#else
