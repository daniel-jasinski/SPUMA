...
#include "deviceHePsiThermo.H"

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

template<class BasicPsiThermo, class MixtureType>
void Foam::deviceHePsiThermo<BasicPsiThermo, MixtureType>::calculate
(
...
template<class BasicPsiThermo, class MixtureType>
Foam::deviceHePsiThermo<BasicPsiThermo, MixtureType>::deviceHePsiThermo
(
    const fvMesh& mesh,
...
:
    deviceHeThermo<BasicPsiThermo, MixtureType>(mesh, phaseName, dictionaryName)
{
    calculate
    (
        this->p_,
...
template<class BasicPsiThermo, class MixtureType>
void Foam::deviceHePsiThermo<BasicPsiThermo, MixtureType>::correct()
{
