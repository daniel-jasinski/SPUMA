...
#include "thermalRASModel.H"

// * * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * //

template<class BasicTurbulenceModel>
void Foam::thermalRASModel<BasicTurbulenceModel>::printCoeffs(const word& type)
{
    if (printCoeffs_)
    {
...
template<class BasicTurbulenceModel>
Foam::thermalRASModel<BasicTurbulenceModel>::thermalRASModel
(
    const word& type,
...
template<class BasicTurbulenceModel>
Foam::autoPtr<Foam::thermalRASModel<BasicTurbulenceModel>>
Foam::thermalRASModel<BasicTurbulenceModel>::New
(
    const alphaField& alpha,
    const rhoField& rho,
    const volVectorField& U,
...
)
{
    ...
    if (modelDict.size() > 0)
    {
        ...
        Info<< "Selecting thermal RAS turbulence model " << modelType << endl;
        ...
        return autoPtr<thermalRASModel>
        (
    ...
    {
        const word modelType = "constant";

        Info<< "Selecting default thermal RAS turbulence model " << modelType << endl;
...
template<class BasicTurbulenceModel>
bool Foam::thermalRASModel<BasicTurbulenceModel>::read()
{
...
Foam::thermalRASModel<BasicTurbulenceModel>::epsilon() const
{
...
template<class BasicTurbulenceModel>
Foam::tmp<Foam::volScalarField>
Foam::thermalRASModel<BasicTurbulenceModel>::omega() const
{
...
template<class BasicTurbulenceModel>
void Foam::thermalRASModel<BasicTurbulenceModel>::correct()
{
