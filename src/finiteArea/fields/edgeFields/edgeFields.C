...
defineTemplateDebugLevelFunction(edgeScalarField::Boundary);
defineTemplateDebugLevelFunction(edgeVectorField::Boundary);
defineTemplateDebugLevelFunction(edgeSphericalTensorField::Boundary);
defineTemplateDebugLevelFunction(edgeSymmTensorField::Boundary);
defineTemplateDebugLevelFunction(edgeTensorField::Boundary);
